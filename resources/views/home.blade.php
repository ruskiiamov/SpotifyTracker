    ...
    <div>
        ...
        <div class="flex flex-col items-center">
            <a id="button" href="{{ route('followed') }}" class="mb-4 bg-green text-black font-bold py-2 px-4 rounded-full w-48 h-12 flex justify-center items-center"
               onclick="getElementById('text').classList.add('hidden'); getElementById('spinner').classList.remove('hidden');"
            >
                <div id="text">Followed Artists</div>
                <div id="spinner" class="flex items-center hidden">
                    <svg class="mr-2 w-6 h-6 text-green animate-spin dark:text-green fill-black" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
