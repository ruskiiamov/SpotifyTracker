...
return [
    ...
    'specialKeyWords' => [
        ...
        GenreCategorizer::HIP_HOP => ['funk mtg', 'funk consciente', 'funk ostentacao', 'funk paulista', 'drain',
            ...
            'jazzhop', 'pop rap', 'pluggnb', 'rkt', 'urbano'],
        GenreCategorizer::WORLD => ['carioca', 'rocksteady', 'dancehall', 'azontobeats', 'manguebeat', 'afrobeat',
            ...
            'roots reggae', 'desi pop', 'tamil pop', 'mambo', 'sarkilar', 'cubaton', 'trinibad', 'afroswing'],
    ...
    'bannedGenreNames' => ['sleep', 'white noise', 'rain', 'world meditation', 'russian chanson', 'kleine hoerspiel',
        ...
        'j-acoustic', 'acoustic', 'kindermusik', 'ensemble stars', 'hypnosis mic', 'cartoon', 'nursery',
        'theremin', 'musica per bambini', "children's choir", "children's music", 'background music',
        'classic soundtrack', 'italian soundtrack', 'vintage italian soundtrack', 'anime piano', 'hardcore',
        'jazz cover', 'bossa nova cover', 'coverchill', 'background jazz', 'funk das antigas', 'pop romantico',
        'russian dance', 'russian dance pop', 'uk funky', 'covertronica', 'australian dance', '432hz',
        'turkish soundtrack', 'norske viser', 'redneck', 'hollywood', 'show tunes', 'german oi', 'idol', 'barnsagor',
        'jawaiian', 'world worship', 'barnemusikk', 'christelijk', 'bornesange', "preschool children's music",
        "nz children's music", 'kodomo no ongaku', 'cocuk sarkilari', 'musica infantil', "children's story",
        'musica para ninos', "british children's music", 'worship', 'opm', 'weirdcore', 'wrestling', 'ambient guitar',
        'adult standards', 'gymcore', 'melbourne bounce international', 'relaxative'],
];
