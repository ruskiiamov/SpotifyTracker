...
return [
    ...
    'regularKeyWords' => [
        ...
        GenreCategorizer::BLUES_JAZZ_FUNK => ['jazz', 'blues', 'funk', 'swing', 'fusion'],
        GenreCategorizer::CLASSICAL => ['classical', 'orchestra', 'romantic', 'choir', 'ballet class', 'baroque'],
        GenreCategorizer::WORLD => ['samba', 'rumba', 'cumbia', 'tango', 'norteno', 'bossa nova', 'indigenous',
            'reggae', 'ska', 'flamenco', 'salsa', 'hawaiian', 'arrocha', 'latin', 'trova', 'minyao', 'world'],
    ],
    ...
    'specialKeyWords' => [
        GenreCategorizer::ROCK => ['pop punk', 'rap rock', 'ska punk', 'dance-punk', 'dance rock', 'straight edge',
            ...
            'new wave', 'lovsang', 'visual kei', 'shoegaze', 'psychedelic'],
        GenreCategorizer::POP_RB_SOUL => ['singer-songwriter', 'diva house', 'laulaja-lauluntekija', 'francoton',
            ...
            'alt z', 'alternative dance', 'worship', 'idol', 'otacore', 'men chika', 'dream smp', 'shonen', 'vtuber'],
        ...
        GenreCategorizer::WORLD => ['carioca', 'rocksteady', 'dancehall', 'azontobeats', 'manguebeat', 'afrobeat',
            ...
            'hare krishna', 'mantra', 'israeli mediterranean', 'bolero'],
    ...
    'bannedGenreNames' => ['sleep', 'white noise', 'rain', 'world meditation', 'russian chanson', 'kleine hoerspiel',
        ...
        'icelandic experimental', 'japanese guitar', 'japanese vgm', 'reiki', 'barnmusik', 'movie tunes', 'nu age',
        ...
        'jawaiian', 'barnemusikk', 'christelijk', 'bornesange', "preschool children's music", 'musique pour enfants',
        "nz children's music", 'kodomo no ongaku', 'cocuk sarkilari', 'musica infantil', "children's story",
        'musica para ninos', "british children's music", 'opm', 'weirdcore', 'wrestling', 'ambient guitar', 'komedi',
        'adult standards', 'gymcore', 'melbourne bounce international', 'relaxative', 'detskie pesni', 'nz christian',
        'background piano', 'japanese piano', 'new age piano', 'erotica', 'afrikaans', 'korean ost', 'comic',
        'viet remix', "australian children's music", 'remix product', 'instrumental lullaby', 'calming instrumental',
        'junior eurovision', 'cover acustico', 'new age', 'turkce remix', 'eurovision', 'histoire pour enfants'],
];
